...
#     # 영준
#     # 민성
#     'TUEG', 'Resting State EEG Data',
#     'SEED-IV', 'SEED', 'DREAMER', 'Emobrain',
#     'BCI IV-2a', 'BCI IV-2b', 'BCI IV-1', 'High-Gamma',
#     'SHHS', '2018 Physionet Challenge',
#     'Neonate', 'Bonn', 'Siena',
#     'FatigueSet'
#     'Berlin(dsr)'
#     'Berlin(nback)', 'Mental Arithmetic'
#     'Stew', 'Raw EEG data'
#     'Inria BCI Challenge', 'Target Versus Non-target', 'p300'
...
# # FINETUNING DATASETS
# finetuning_datasets = [
#     'SEED-V', 'DEAP', 'HCI-Tagging_emotion',   # emotion recognition,
#     'Physionet MMI', 'SHU-MI',                 # motor imagery classification,
#     'ISRUC', 'Sleep-EDF(BENDR)',               # sleep stage detection,
#     'IIIC-Seizure', 'TUSZ', 'NMT(Scalp-EEG)',  # seizure detection,
#     'SEED-VIG', 'MEDT',                        # vigilance estimation,
#     'TUEV', 'NMT_events',                      # events classification,
#     'TUAB', 'CHB-MIT',                         # error-related potentials,
#     'TUSL', 'TUAR',                            # else   # TODO: 어디 속하는지 확인
# ]
# # CHANNEL_INFO
# # NOTE: incomplete 
# # datasets_num_chans = {'BCI-NER Challenge': 56, 'BCIC2020-3': 64, 'DEAP': 32, ...}
# # datasets_SY_channels = pd.read_csv('/home/kjiwon0219/jiwon/Nas_folder/EEG_ssc/datasets_channel_info_sy.csv')
# # datasets_SY_channels = datasets_SY_channels.set_index('folder_path')['num_filtered_chans'].to_dict()
# # datasets_num_chans = pd.read_csv('/home/kjiwon0219/jiwon/Nas_folder/EEG_ssc/datasets_channel_info_sy.csv')
# # datasets_num_chans = datasets_num_chans.set_index('folder_path')['num_filtered_chans'].to_dict()
# def get_num_chans(dataset_name, datasets_num_chans=datasets_num_chans):
#     return datasets_num_chans[dataset_name]

# # # dataset
# # # NOTE: incomplete
# # base_dir = '/home/kjiwon0219/jiwon/Nas_folder_EEG/dataset/processed'
# # datasets_SY = ['HCI-Tagging_ERP', 'Mumtaz2016', 'P300', 'SEED-IV', 'SEED-V', 'SEED-VIG']
# # datasets_SY_splitted = ['BCI-NER Challenge', 'BCIC2020-3', ]
# # datasets_SY_multiple_labels = ['DEAP', 'DREAMER', 'HCI-Tagging_emotion',]
# # datasets_SY_else = ['SEED', ]